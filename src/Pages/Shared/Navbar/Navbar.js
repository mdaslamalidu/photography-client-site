              ...
              <>
                ...
                <li>
                  <Link
                    ...
                    href="/"
                    className="inline-flex items-center justify-center px-6 py-1 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-slate-700 hover:bg-slate-800 focus:shadow-outline focus:outline-none"
                    aria-label="Sign up"
                    title="Log Out"
                  >
                    Log Out
                      ...
                      {user?.email ? (
                        ...
                        <li>
                          <Link
                            ...
                            aria-label="Our product"
                            title="Our product"
                            className="font-medium tracking-wide text-black transition-colors duration-200 hover:text-teal-400"
                          >
                            Log In
                          </Link>
                        </li>
